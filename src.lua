...
function lib:Window(text, preset, closebind)
    ...
    TabHold.Position = UDim2.new(0.016, 0, 0.082, 0)
    TabHold.Size = UDim2.new(0, 107, 0, 452)
    ...
    Title.Position = UDim2.new(0.016, 0, 0.016, 0)
    ...
    function lib:Notification(texttitle, textdesc, textbtn)
        ...
        NotificationFrame:TweenPosition(UDim2.new(0.850, 0, 0.850, 0), "Out", "Sine", .3, true)

        OkayBtn.Name = "OkayBtn"
        OkayBtn.Parent = NotificationFrame
        OkayBtn.BackgroundColor3 = Color3.fromRGB(34, 34, 34)
        OkayBtn.BackgroundTransparency = 1.000
        OkayBtn.Position = UDim2.new(0.918, 0, 0, 0)
        OkayBtn.Size = UDim2.new(0, 25, 0, 25)
        OkayBtn.AutoButtonColor = false
        OkayBtn.ZIndex = 2
        OkayBtn.ImageRectOffset = Vector2.new(284, 4)
        OkayBtn.ImageRectSize = Vector2.new(24, 24)
        OkayBtn.Image = "rbxassetid://3926305904"

        NotificationTitle.Name = "NotificationTitle"
        NotificationTitle.Parent = NotificationFrame
        NotificationTitle.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
        NotificationTitle.BackgroundTransparency = 1.000
        NotificationTitle.Position = UDim2.new(0.039, 0, 0, 0)
        NotificationTitle.Size = UDim2.new(0, 267, 0, 25)
        NotificationTitle.Font = Enum.Font.Gotham
        NotificationTitle.Text = texttitle
        NotificationTitle.TextColor3 = Color3.fromRGB(255, 255, 255)
        NotificationTitle.TextSize = 19.000
    ...
    function tabhold:Tab(text)
        ...
        local TabTitleCorner = Instance.new("UICorner")
        ...
        TabTitleCorner.Name = "TabTitleCorner"
        TabTitleCorner.Parent = TabTitle
